...
* Immutable
* Append-only
* Totally ordered (linear history in v1)
...
```bash
myosotis init state.myo
myosotis create Agent
myosotis set <node_id> goal "Explore"
myosotis commit "initial goal"
myosotis history
myosotis show <node_id> --at <commit>
myosotis diff <commit_a> <commit_b>
```
